  ...
  eq(other) {
    ...
    return (
      ...
      (other instanceof MarkDecoration &&
        ...
        (this.class ||
          ((_a = this.attrs) === null || _a === void 0 ? void 0 : _a.class)) ==
          (other.class ||
  ...
  for (let iI = 0, prev = outerType; iI <= isolates.length; iI++) {
    ...
    for (let i = from; i < to; ) {
      ...
      if (type == 256 /* T.NI */) {
        ...
        let replace =
          beforeL == afterL ? (beforeL ? 1 /* T.L */ : 2 /* T.R */) : outerType;
        for (
...
class ViewUpdate {
  ...
  get geometryChanged() {
    return (
      this.docChanged ||
      (this.flags & (8 /* UpdateFlag.Geometry */ | 2)) /* UpdateFlag.Height */ >
        0
    );
  }
  /**
...
class DocView extends ContentView {
        ...
        if (!rawSel);
          ...
          if (browser.gecko) {
            ...
            if (
              ...
              let text = (
                nextTo == 1 /* NextTo.Before */ ? textNodeBefore : textNodeAfter
  ...
  maybeCreateCompositionBarrier() {
    ...
    this.compositionBarrier = found
      ? Decoration.set(compositionBarrierWidget.range(head))
      : Decoration.none;
    return !!found;
  }
...
class InputState {
  ...
  flushIOSKey(change) {
    ...
    return dispatchKey(
      ...
      key.key,
      key.keyCode,
      key instanceof KeyboardEvent ? key : undefined
    );
  }
...
class HeightMapGap extends HeightMap {
  ...
  lineAt(value, type, oracle, top, offset) {
    ...
    let lineTop =
      top + perLine * linesAbove + perChar * (line.from - offset - linesAbove);
    return new BlockInfo(
      line.from,
      line.length,
...
const plugin = /*@__PURE__*/ ViewPlugin.fromClass(
  class {
    constructor() {
      this.height = 1000;
  ...
  mousemove(event) {
    ...
    if (
      ...
      let { pos } = active[0] || this.pending,
          ...
          (_b =
            (_a = active[0]) === null || _a === void 0 ? void 0 : _a.end) !==
            null && _b !== void 0
            ? _b
            : pos;
      if (
