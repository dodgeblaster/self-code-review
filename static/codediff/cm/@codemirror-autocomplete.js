...
class FuzzyMatcher {
  ...
  match(word) {
    ...
    for (
      let i = 0, e = Math.min(word.length, 200), prevType = 0 /* Tp.NonWord */;
      i < e && byWordTo < len;
    ...
    if (adjacentTo == len)
      return this.ret(
        -200 /* Penalty.CaseFold */ + -700 /* Penalty.NotStart */ - word.length,
...
class CompletionTooltip {
  ...
  update(update) {
    ...
    if (cState != prevState) {
      ...
      if (
        disabled !=
        ((_a = prevState.open) === null || _a === void 0 ? void 0 : _a.disabled)
      )
...
class CompletionState {
  ...
  update(tr) {
    ...
    if (
      ...
      active = active.map((a) =>
        a.hasResult() ? new ActiveSource(a.source, 0 /* State.Inactive */) : a
      );
  ...
  handleUserEvent(tr, type, conf) {
    ...
    if (
      ...
      return new ActiveResult(
        ...
        result,
        result.from,
        (_a = result.to) !== null && _a !== void 0 ? _a : cur(tr.state)
      );
...
const windows =
  typeof navigator == "object" && /*@__PURE__*/ /Win/.test(navigator.platform);
...
function completionStatus(state) {
  ...
  return cState && cState.active.some((a) => a.state == 1 /* State.Pending */)
    ? "pending"
