...
const frontier1 = /*@__PURE__*/ new Frontier(),
  frontier2 = /*@__PURE__*/ new Frontier();
    ...
    if ((lenA && lenB) || lenA > 3 || lenB > 3) {
      ...
      if (!lenA || !lenB) {
        ...
        if (lenBefore && lenAfter) {
          ...
          (indentLen =
            change.fromA -
            (indentBefore = findIndentBefore(
              a,
              change.fromA,
              maxScanBefore
            ))) &&
          a.slice(indentBefore, change.fromA) ==
            changeText.slice(changeTo - indentLen, changeTo)
        ) {
          change = changes[i] = new Change(
            indentBefore,
            indentBefore + lenA,
            change.fromB - indentLen,
            change.toB - indentLen
          );
        }
      }
...
function diff(a, b, config) {
  var _a;
  scanLimit =
    ((_a = config === null || config === void 0 ? void 0 : config.scanLimit) !==
      null && _a !== void 0
      ? _a
      : 1e9) >> 1;
...
function toChunks(changes, a, b, offA, offB) {
  ...
  for (let i = 0; i < changes.length; i++) {
    ...
    chunks.push(
      new Chunk(chunk, fromA, Math.max(fromA, toA), fromB, Math.max(fromB, toB))
    );
  }
  return chunks;
}
...
const decorateChunks = /*@__PURE__*/ ViewPlugin.fromClass(
  class {
    constructor(view) {
...
const changeGutter = /*@__PURE__*/ Prec.low(
  /*@__PURE__*/ gutter({
    class: "cm-changeGutter",
    markers: (view) => {
      var _a;
      return (
        ((_a = view.plugin(decorateChunks)) === null || _a === void 0
          ? void 0
          : _a.gutter) || RangeSet.empty
      );
    },
  })
);
...
const inserted = /*@__PURE__*/ Decoration.mark({
  tagName: "ins",
  class: "cm-insertedLine",
});
const deleted = /*@__PURE__*/ Decoration.mark({
  tagName: "del",
...
const externalTheme = /*@__PURE__*/ EditorView.styleModule.of(
  /*@__PURE__*/ new StyleModule({
    ".cm-mergeView": {
      overflowY: "auto",
    },
    ".cm-mergeViewEditors": {
...
const collapseCompartment = /*@__PURE__*/ new Compartment(),
  configCompartment = /*@__PURE__*/ new Compartment();
/**
...
const unifiedChangeGutter = /*@__PURE__*/ Prec.low(
  /*@__PURE__*/ gutter({
    class: "cm-changeGutter",
    markers: (view) => {
      var _a;
...
function acceptChunk(view, pos) {
  let { state } = view,
    at = pos !== null && pos !== void 0 ? pos : state.selection.main.head;
